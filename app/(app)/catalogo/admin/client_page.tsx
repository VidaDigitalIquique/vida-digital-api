  ...
  const handleCreate = async () => {
    try {
      const res = await fetch('/api/catalogos', {
        ...
        body: JSON.stringify({ empresaId: activeEmpresaId, titulo: newTitle, descripcion: newDesc }),
      });
      if (res.ok) {
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
             <div className="space-y-2">
                ...
                <Input value={newTitle} onChange={e => setNewTitle(e.target.value)} placeholder="Ej: Ofertas Navidad 2026" />
             </div>
             <div className="space-y-2">
