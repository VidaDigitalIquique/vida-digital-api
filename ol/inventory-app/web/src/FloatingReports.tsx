...
export default function FloatingReports() {
  ...
  async function fetchSummary() {
    ...
    if (!productCode) { toast.error("Ingresa un Cï¿½digo"); return; }
    setLoading(true);
    try {
        ...
        >
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
              <h2 style={{ margin: 0 }}>Reporte r?fï¿½pido por producto</h2>
              <button onClick={() => setOpen(false)} style={{ background: "transparent", border: "none", fontSize: 18, cursor: "pointer" }}>ï¿½?"???</button>
            </div>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 12 }}>
              <input
                ...
                placeholder="Cï¿½digo de producto (ej: SF-2074)"
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ background: "#f8fafc" }}>
                    <th style={{ textAlign: "left", padding: 8, borderBottom: "1px solid #eee" }}>Cï¿½digo</th>
                    <th style={{ textAlign: "right", padding: 8, borderBottom: "1px solid #eee" }}>Cajas (teï¿½rico)</th>
                    <th style={{ textAlign: "right", padding: 8, borderBottom: "1px solid #eee" }}>Cajas (Fï¿½sico)</th>
            ...
            {!data && (
              <div style={{ color: "#64748b", fontSize: 14 }}>
                Ingresa un Cï¿½digo y presiona <b>Consultar</b> para ver el resumen.
              </div>
            )}
          </div>
        </div>
